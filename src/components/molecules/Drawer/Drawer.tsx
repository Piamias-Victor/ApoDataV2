        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Panel */}
                    <motion.div
                        className={`fixed top-0 right-0 h-full ${width} z-50 bg-white shadow-2xl flex flex-col`}
                        initial={{ x: '100%' }}
                        animate={{ x: 0 }}
                        exit={{ x: '100%' }}
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-8 py-6 bg-white/80 backdrop-blur-md z-10">
                            <div>
                                ...
                                <div className={`h-1 w-12 rounded-full mt-2 ${accentColor === 'orange' ? 'bg-orange-500' : 'bg-blue-600'}`} />
                            </div>
                            <button
                                onClick={onClose}
