...
import { useLaboratoryAnalysis } from '@/components/organisms/LaboratoryAnalysis/hooks/useLaboratoryAnalysis';
import {
    Loader2,
    FlaskConical,
    Search
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                <thead className="bg-gray-50/80 backdrop-blur sticky top-0 z-10 border-b border-gray-100">
                                    <tr>
                                        {/* LABO */}
                                        <TableHeaderCell isSticky width="18%" {...getSortProps('laboratory_name')}>Laboratoire</TableHeaderCell>
                                        ...
                                        {/* STOCK - Red (Value Only as requested) */}
