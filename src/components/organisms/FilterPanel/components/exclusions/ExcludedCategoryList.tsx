// src/components/organisms/FilterPanel/components/exclusions/ExcludedCategoryList.tsx
...
interface ExcludedCategoryListProps {
...
export const ExcludedCategoryList: React.FC<ExcludedCategoryListProps> = ({
    items, isLoading, hasSelection, searchQuery, selectedMap, onToggle
}) => {
    if (isLoading) {
        return <FilterLoadingState message="Chargement des catégories..." color="gray" />;
    }
