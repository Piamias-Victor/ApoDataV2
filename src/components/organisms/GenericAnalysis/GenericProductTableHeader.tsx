    ...
    return (
        <thead className="bg-gray-50/80 backdrop-blur sticky top-0 z-10 border-b border-gray-100">
            <tr>
                ...
                <TableHeaderCell width="6%" align="right" variant="pink" {...getSortProps('prix_brut')}>P.Brut</TableHeaderCell>
                <TableHeaderCell width="6%" align="right" variant="pink" {...getSortProps('avg_purchase_price')}>P.Achat</TableHeaderCell>
