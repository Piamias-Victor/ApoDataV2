...
/**
 * PharmacyDrawer Component - Drawer pour filtres pharmacie
 * 
 * Drawer 400px fixe, animation slide depuis la droite
 * Contenu blanc vide pour le moment - Visible seulement pour les admins
 */
        ...
        <div className="flex-1 p-6">
          <div className="h-full flex items-center justify-center">
            <div className="text-center text-gray-500">
              <p className="text-sm">Contenu des filtres pharmacie</p>
              <p className="text-xs mt-1">À implémenter - Admin seulement</p>
            </div>
          </div>
        </div>
      </motion.div>
