...
import { PriceKpiCards } from '@/components/organisms/PriceAnalysis/PriceKpiCards';
import { PriceEvolutionSection } from '@/components/organisms/PriceAnalysis/PriceEvolutionSection';
import { PriceProductTable } from '@/components/organisms/PriceAnalysis/PriceProductTable';
            ...
            <div className="relative z-10 pt-8 px-8 pb-8">
                <div className="max-w-7xl mx-auto space-y-8 pt-6">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-3xl font-bold text-gray-900">Analyse des Prix</h1>
                        <p className="text-gray-600">Evolution des prix d&apos;achats, de ventes et des marges</p>
                    </div>
