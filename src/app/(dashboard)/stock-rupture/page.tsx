...
import { StockDashboard } from '@/components/organisms/StockDashboard/StockDashboard';
            ...
            <div className="relative z-10 pt-8 px-8 pb-8">
                <div className="max-w-7xl mx-auto space-y-8 pt-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <h1 className="text-3xl font-bold text-gray-900">Stock & Ruptures</h1>
                        <p className="text-gray-600">Analyse de la disponibilité des produits et valorisation du stock</p>
                    </div>
