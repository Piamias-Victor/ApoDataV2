...
export async function PATCH(
  ...
  try {
    ...
    if (updateData.ca_rank !== undefined) {
      updates.push(`ca_rank = $${paramIndex++}`);
      values.push(updateData.ca_rank);
    }
    ...
    return NextResponse.json({
      ...
      pharmacy: {
        ...
        ca_rank: updatedPharmacy.ca_rank ? parseInt(updatedPharmacy.ca_rank.toString()) : null,
